...
TEST_IMAGES_DIR = Path(__file__).resolve().parent / "pytest_images"
...
def test_model_not_found(client):
    # Probar la respuesta de la API cuando un modelo no existe
    response = client.get("/models/rating/Model_999")
